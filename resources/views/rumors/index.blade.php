...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 antialiased transition-colors duration-300">
    ...
    <div class="max-w-5xl mx-auto mt-10 px-4">
        ...
        @if(session('success'))
            <div
                class="mb-6 p-4 rounded-xl bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 shadow flex items-center gap-2 transition">
                ✅ {{ session('success') }}
            </div>
        @endif
        ...
        <div class="grid gap-8 md:grid-cols-2">
            @forelse($rumors as $rumor)
                <div
                    class="group bg-white dark:bg-gray-700 rounded-2xl shadow-md hover:shadow-xl transition overflow-hidden flex flex-col text-gray-900 dark:text-gray-200">
                    @if($rumor->image)
