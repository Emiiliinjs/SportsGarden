...
<div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6 flex items-center gap-4">
        ...
        <p class="text-2xl font-bold text-gray-900 dark:text-white">
            {{ \App\Models\Comment::count() }}
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-6">
                    ...
                    <div class="space-y-4">
                        @forelse(\App\Models\Rumor::latest()->take(5)->get() as $rumor)
                        ...
                        @empty
                            <p class="text-gray-600 dark:text-gray-400">No rumors available.</p>
                        @endforelse
                    </div>
                </div>
            @else
    ...
    <script>
        const chartEl = document.getElementById('visitsChart');
        if (chartEl) {
