...
<body class="bg-gray-100 text-gray-800 antialiased">
    ...
    <div class="fixed inset-0 -z-10">
        <img src="https://cdn.wallpapersafari.com/38/50/vI1cZ2.jpg"
            class="w-full h-full object-cover filter blur-sm brightness-75" alt="Sports Background">
    </div>
    ...
    <div class="relative z-10">
        ...
        <section class="relative h-[65vh] flex flex-col items-center justify-center">
            <div
                class="bg-white bg-opacity-90 backdrop-blur-md rounded-xl p-8 text-center max-w-3xl shadow-md transition duration-300">
                <h1 class="text-4xl md:text-5xl font-extrabold text-gray-900">Latest Sports News</h1>
                <p class="text-lg text-gray-700 mt-3">Stay updated with the hottest news from around the sports world
                </p>
        ...
        @if(request('query'))
            <div
                class="max-w-3xl mx-auto mt-6 p-4 bg-white bg-opacity-90 backdrop-blur-md rounded-xl shadow-md text-center">
        ...
        <section class="py-16">
            <div
                class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white bg-opacity-90 rounded-xl shadow-md transition duration-300">
                ...
                <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
                    @forelse($news as $item)
                        <div
                            class="group bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden flex flex-col text-gray-900">
                            ...
                            <div class="relative">
                                ...
                                <span
                                    class="absolute top-4 left-4 bg-blue-600 text-white text-xs font-semibold px-3 py-1 rounded-full shadow">
                                    {{ $item->source ?? 'Unknown' }}
                                </span>
                            </div>
